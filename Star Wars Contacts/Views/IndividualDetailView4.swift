...
struct IndividualDetailView4: View {
    ...
    var body: some View {
        NavigationView {
            ...
            .background(Color.customChineseliulv.opacity(0.6)
                            ...
                            ScrollView {
                                VStack(alignment: .leading) {
                                    LabelDetailRowLineByLine    (value: storyContent,
                                                             ...
                                                             textColor: .customChineseGray, // Default text color
                                                                 textHighlightColor: .white, fontSize: 16 )
                                    .padding()
                                }
                                .padding(.horizontal, 32)
                            }
